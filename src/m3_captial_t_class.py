...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        corner_point1 = rg.Point(intersection_center.x - width / 2, intersection_center.y - letter_thickness / 2)
        corner_point2 = rg.Point(intersection_center.x + width / 2, intersection_center.y + letter_thickness / 2)
        self.h_rect = rg.Rectangle(corner_point1, corner_point2)
        corner_point3 = rg.Point(intersection_center.x + letter_thickness / 2, intersection_center.y - letter_thickness / 2)
        corner_point4 = rg.Point(intersection_center.x - letter_thickness / 2,
                                 intersection_center.y + (height - (letter_thickness / 2)))
        self.v_rect = rg.Rectangle(corner_point3, corner_point4)
    ...
    def clone(self):
        ...
        clone = CapitalT(self.h_rect.get_center(), self.h_rect.get_width(), self.v_rect.get_height(),
